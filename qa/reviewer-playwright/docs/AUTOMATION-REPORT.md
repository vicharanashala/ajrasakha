...
| RESP-002     | expert can open the metadata dialog                                           | `03-response.md`            | `response.page.ts`, `response.spec.ts`                | View Metadata button; Question Details dialog                                                                         | ✅ Automated     |
| RESP-003     | metadata dialog displays all expected sections                                | `03-response.md`            | `response.page.ts`, `response.spec.ts`                | Summary section, Metadata section, Details section                                                                    | ✅ Automated     |
| RESP-004     | metadata dialog displays expected metadata fields                             | `03-response.md`            | `response.page.ts`, `response.spec.ts`                | State, District, Crop, Normalized Crop, Season, Domain labels                                                         | ✅ Automated     |
| RESP-005     | metadata dialog displays populated metadata values                            | `03-response.md`            | `response.page.ts`, `response.spec.ts`                | Summary and Details metadata labels with associated populated values                                                  | ✅ Automated     |
| RESP-006     | reviewer can enter a draft response                                           | `03-response.md`            | `response.page.ts`, `response.spec.ts`                | Draft Response textarea accepts and displays input                                                                    | ✅ Automated     |
| RESP-007     | reviewer can enter remarks                                                    | `03-response.md`            | `response.page.ts`, `response.spec.ts`                | Remarks textarea accepts and displays input                                                                           | ✅ Automated     |
| RESP-008     | reset clears draft response and remarks                                       | `03-response.md`            | `response.page.ts`, `response.spec.ts`                | Reset button, Draft Response textarea, Remarks textarea                                                               | ✅ Automated     |
| RESP-009     | submit button is enabled after entering a draft response                      | `03-response.md`            | `response.page.ts`, `response.spec.ts`                | Submit button state, Draft Response textarea                                                                          | ✅ Automated     |
| RESP-010     | reviewer can successfully submit a response                                   | `03-response.md`            | `response.page.ts`, `response.spec.ts`                | Draft Response textarea, Submit button, submission success indicator                                                  | ✅ Automated     |
| RESP-011     | response form resets after successful submission                              | `03-response.md`            | `response.page.ts`, `response.spec.ts`                | Draft Response textarea, Source References, Submit button, Submit Response confirmation dialog, next question loading | ✅ Automated     |
