...
## MOD-018-SMOKE — Moderator can open Question Details page
...
Verify that a moderator can successfully navigate from the **All Questions** list to the **Question Details** page after creating a question.

This smoke test validates that the navigation flow and the newly created `ModeratorQuestionDetailsPage` page object are correctly wired before adding detailed assertions.

**Preconditions**

- Moderator is authenticated.
- Moderator has access to the **All Questions** page.
- Question creation is functioning correctly.

**Test Flow**

1. Login as moderator.
2. Wait for the moderator dashboard to load.
3. Navigate to the **All Questions** tab.
4. Open the **Create Question** dialog.
5. Enter a unique question.
6. Select the required metadata:
...
8. Verify the success notification is displayed.
9. Click the newly created question from the **All Questions** table.
10. Verify that the **Question Details** page opens successfully.

**Assertions**

- Question is created successfully.
- Success toast **"Question submitted successfully."** is displayed.
- Clicking the question opens the **Question Details** page.
- The question title (page heading) is visible, confirming successful navigation.
...
This is a smoke test intended to validate navigation and page object initialization only. Detailed verification of the question title, metadata, header controls, lifecycle, audit, and allocation information will be covered in subsequent tests.
