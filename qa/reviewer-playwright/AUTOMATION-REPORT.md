...
| QDET-002     | selected question details persist after browser reload                        | `02-question-details.md`    | home search, selected-question hook, auto-open effect | URL query; H1                                                   | Blocked before discovery: Node/npm/npx unavailable |
