...
export interface IChatbotService {
  ...
  getUserDetails(startDate?: string, endDate?: string, page?: number, limit?: number, search?: string, source?: string, crop?: string, village?: string, profileCompleted?: string, farmerType?: 'all' | 'internal' | 'external', inactiveOnly?: boolean): Promise<PaginatedUserDetails>;
