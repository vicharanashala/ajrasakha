...
export class QuestionService extends BaseService implements IQuestionService {
  ...
  async addQuestion(
    ...
    0.658827225118875504,
    0.932776884734630585,
    0.407828179746866226,
    0.351376041024923325,
    -0.56074283466674387455,
    -0.02885739877820015,
    ...
    0.465687041208148003,
    -0.2308677019504830241,
    0.455102392062544823,
    0.01662163995206356,
    0.893631745697930455,
    0.007040149997919798,
    0.676916589103639126,
    -0.56256983309984207,
    0.03274351358413696,
    ...
    -0.06017487123608589,
    0.04003242403268814,
    0.035913781714439392,
    -0.019305765438,
    0.057421462297439575,
    ...
    0.89670409977436066,
    0.032607355118,
    -0.368190681226551533,
    0.78879922091960907,
    0.451943893507122993,
    0.0017812745844,
    0.02767101116478443,
    -0.0122424077177,
...
console.log("Source 1", source);
    ...
    logData.totalMatches = topSimilar.length
	  ...
	  const bestFour = topSimilar.slice(0, 25)
...
/*     
      ...
      */
      ...
      return this._withTransaction(async (session: ClientSession) => {
        ...
        // =====================================================
        /* Logic Flow
         *  1. If score ≥ 95 → duplicate immediately
            2. Collect all questions with score 85–95
            3. Call checkConceptDuplicate once
            4. If true → treat highest scoring candidate as duplicate
        */
        ...
        break
		  ...
		  if (highestScore >= 25 && highestScore < 99) {
      ...
      if (!isDuplicate && llmCandidates.length > 0) {
        ...
        let filtermatchinQuestion=llmCandidates.filter(ele=>ele.question==matchedQuestionfromllm)
