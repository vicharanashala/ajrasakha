...
export enum AuditAction {
  ...
  TOGGLE_MODERATOR_ALLOCATION = 'TOGGLE_MODERATOR_ALLOCATION',
  ...
  // PAE Validation assignment
  SELECT_PAE_VALIDATION_REVIEWER = 'SELECT_PAE_VALIDATION_REVIEWER',
  DELETE_PAE_VALIDATION_REVIEWER = 'DELETE_PAE_VALIDATION_REVIEWER',
  TOGGLE_PAE_VALIDATOR_ALLOCATION = 'TOGGLE_PAE_VALIDATOR_ALLOCATION',
  

  // Feedback-review assignment
  ...
  ASSIGN_TRAINING_USER = 'ASSIGN_TRAINING_USER',
  REMOVE_TRAINING_USER = 'REMOVE_TRAINING_USER',
  ...
  NEW_SOURCE_COMPLETE = 'NEW_SOURCE_COMPLETE',
  NEW_SOURCE_CLOSE = 'NEW_SOURCE_CLOSE',
  RECORD_MISSING_POP_DOCUMENT = 'RECORD_MISSING_POP_DOCUMENT',
  NEW_SOURCE_RELEASE = 'NEW_SOURCE_RELEASE',
  MODERATOR_REVIEW_START = 'MODERATOR_REVIEW_START',
  MODERATOR_REVIEW_RELEASE = 'MODERATOR_REVIEW_RELEASE',
  NEW_SOURCE_CHANGE_STATUS = 'NEW_SOURCE_CHANGE_STATUS',
