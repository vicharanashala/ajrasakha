...
// same module file AnswerApprovalService imports ('../utils/triggerWebhook.js').
...
import { AnswerApprovalService } from '../services/AnswerApprovalService.js';
...
function buildService(): AnswerApprovalService {
  return new AnswerApprovalService(
    {} as any, // aiService
    {} as any, // answerRepo
...
describe('AnswerApprovalService.notifyCustomerOnClose — per-question customer webhook', () => {
  let service: AnswerApprovalService;

  const call = (q: any) =>
    service.notifyCustomerOnClose(q, 'the answer', [], 'Expert Name', null);
