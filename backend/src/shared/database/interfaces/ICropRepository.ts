...
export interface ICropRepository {
  createCrop(name: string, createdBy: string, aliases?: ICropAlias[], type?: CropType, status?: string): Promise<ICrop>;
  getAllCrops(query?: {
    search?: string;
  ...
  updateCrop(id: string, updates: {name?: string; aliases?: (ICropAlias | string)[]; status?: string; type?: CropType}, updatedBy: string): Promise<ICrop | null>;
