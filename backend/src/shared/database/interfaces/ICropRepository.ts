...
export interface ICropRepository {
  createCrop(name: string, createdBy: string, aliases?: ICropAlias[], type?: CropType, status?: 'Restricted' | 'Banned', otherType?: string): Promise<ICrop>;
  getAllCrops(query?: {
    search?: string;
  ...
  updateCrop(id: string, updates: {name?: string; aliases?: (ICropAlias | string)[]; status?: 'Restricted' | 'Banned'; otherType?: string}, updatedBy: string): Promise<ICrop | null>;
