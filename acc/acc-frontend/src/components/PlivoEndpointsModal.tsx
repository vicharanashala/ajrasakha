          ...
          <div className="bg-zinc-50 dark:bg-zinc-950/50 p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <div>
                <label className="text-[11px] font-semibold text-muted-foreground flex items-center gap-1 mb-1">
                  <span>Agent ID</span>
                  <span className="text-[10px] text-primary-accent font-normal flex items-center gap-0.5">
                ...
                <Input
                  ...
                  readOnly
                  disabled
                  className="bg-primary-accent/10 text-xs h-9 font-mono font-bold text-primary-accent border-primary-accent/30 cursor-not-allowed"
                />
              </div>
            ...
            <div className="flex justify-end pt-1">
              <Button
                ...
                disabled={isAdding}
                className="gap-2 btn-primary-emerald text-xs h-8 shadow-sm"
              >
                          ...
                          {isEditing ? (
                            <>
                              <Button
                                ...
                                className="h-7 px-2.5 text-xs btn-primary-emerald gap-1"
                              >
                            ...
                            <>
                              <Button
                                ...
                                className="h-7 px-2 text-xs text-primary-accent hover:bg-primary-accent/10 gap-1"
                              >
