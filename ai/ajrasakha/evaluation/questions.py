TEST_CASES = [
    ...
    },
    {
        ...
        "expected_answer": "Based on soil test values (N 120, P 40, K 30, OC 0.5%) for Rice in Ropar, Punjab, apply balanced fertilizer dosage: approximately 100-120 kg Nitrogen (approx 2.5 bags Urea), 30 kg Phosphorus (approx 1.5 bags SSP/DAP equivalent), and 30 kg Potassium (MOP) per acre according to PAU fertilizer guidelines.",
        "stable": False,
        "expected_nodes": ["planner", "execute_plan", "assemble_answer_body", "translate_answer"],
    ...
    },
    {
        ...
        "expected_answer": "For growing paddy in Punjab, sow recommended PAU varieties such as PR 126 or PR 131. Prepare nursery in May-June and transplant 25-30 days old seedlings with 20x15 cm spacing. Apply balanced NPK fertilizers (e.g. 100-120 kg Nitrogen, 30 kg P2O5 per hectare) and ensure proper water management.",
        "stable": True,
