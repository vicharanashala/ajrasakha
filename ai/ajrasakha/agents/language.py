...
def _llm_detect_language(text: str) -> str:
    ...
    try:
        ...
        prompt = (
            ...
            "- English crop names: paddy, wheat, rice, maize, cotton, sugarcane, soybean, groundnut, potato, onion, tomato\n"
            "- Hindi crop names: gehu, chawal, makka, ganne, aloo, pyaz, tamatar, kanak\n"
            "- If English crop name → English\n"
            "- If Hindi crop name → Hindi\n\n"
