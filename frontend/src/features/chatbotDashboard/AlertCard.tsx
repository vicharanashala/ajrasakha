        ...
        <div className="min-w-0 flex-1 mr-2">
          <div className="text-[13px] font-medium text-[var(--card-foreground)] flex items-center gap-1.5">
            ...
            <button
                ...
                className="absolute top-5 right-5 z-50 rounded-lg border border-gray-200/60 p-1.5 shadow-sm backdrop-blur-sm transition-all duration-200 hover:bg-white hover:shadow-md dark:border-[#333]"
                title="Refresh"
              >
                <RefreshCw
