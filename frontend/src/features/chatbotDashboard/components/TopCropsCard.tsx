 ...
 flex flex-col h-full shadow-sm overflow-hidden relative"
      >
        ...
        <button
          ...
          className="absolute top-4 right-14 z-20 rounded-lg border border-gray-200/60 p-1.5 shadow-sm backdrop-blur-sm transition-all duration-200 hover:bg-white hover:shadow-md dark:border-[#333] dark:bg-gray-800/70"
          title="Refresh"
        >
          <RefreshCw
