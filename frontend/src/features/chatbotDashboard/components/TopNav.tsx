...
export function TopNav({ season }: TopNavProps) {
  return (
    <div style={{ background: "#0F4A24", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 20px", height: 52, flexShrink: 0 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ width: 28, height: 28, borderRadius: "50%", background: "#1E7A3C", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: 11, fontWeight: 500 }}>
          PK
        </div>
      </div>
    </div>
