...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger, DialogFooter, DialogClose } from "@/components/atoms/dialog";
...
export const QuestionsFilters = ({
  ...
  const handleDownloadReport = async () => {
    ...
    const diffInMs = downloadDateRange.to.getTime() - downloadDateRange.from.getTime();
    ...
    try {
      ...
      const blob = await questionService.downloadQuestionReport(undefined, startDate, endDate);
            ...
            <Dialog open={isDateDialogOpen} onOpenChange={setIsDateDialogOpen}>
              <Tooltip>
                ...
                <TooltipContent side="bottom" className="max-w-xs">
                  <p className="text-sm">
                    Download Excel report of questions with 2 consecutive approvals that need modification or rejection. Select a date range up to 1 month.
                  </p>
                </TooltipContent>
              </Tooltip>
            <DialogContent className="max-w-[min(90vw,800px)] w-full max-h-[90vh] overflow-hidden flex flex-col p-4">
              <DialogHeader className="space-y-2 flex-shrink-0">
                ...
                <div className="text-xs text-muted-foreground bg-muted/50 p-2 rounded-md border">
                  Select a date range to download questions with 2 consecutive approvals.
