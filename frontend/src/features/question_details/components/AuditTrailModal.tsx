...
const actionLabels: Record<string, string> = {
  ...
  SELECT_FEEDBACK_REVIEWER: "Feedback Reviewer Selected",
  DELETE_FEEDBACK_REVIEWER: "Feedback Reviewer Removed",
  TOGGLE_FEEDBACK_ALLOCATION: "Feedback Auto-Allocation Toggled",
  FEEDBACK_ACTION: "Feedback Accepted / Rejected",
