  ...
  return (
    <>
      {selectedQuestionId && questionDetails ? (
        ...
        <Card className="h-[80vh] md:h-[110vh] border border-gray-200 dark:border-gray-700 shadow-lg rounded-xl bg-transparent backdrop-blur-sm mb-6 md:mb-0">
