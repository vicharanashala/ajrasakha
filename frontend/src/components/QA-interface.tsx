...
export const QAInterface = () => {
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 bg-transparent py-4">
      <div className="flex flex-col space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Questions Card */}
          <Card className="w-full max-h-[80vh] border border-gray-200 dark:border-gray-700 shadow-sm rounded-lg bg-transparent">
          ...
          <Card className="w-full max-h-[80vh] border border-gray-200 dark:border-gray-700 shadow-sm rounded-lg bg-transparent mb-3 md:mb-0">
    ...
    //       <Card className="max-h-[80vh] border border-gray-200 dark:border-gray-700 shadow-sm rounded-lg bg-transparent">
    ...
    //       <Card className=" border border-gray-200 dark:border-gray-700 shadow-sm rounded-lg bg-transparent ml-4 ">
    //         <CardHeader className="border-b border-gray-200 dark:border-gray-700">
    //           <CardTitle className="text-lg font-semibold">Response</CardTitle>
    //         </CardHeader>
    //         <CardContent className="h-full flex flex-col space-y-6 p-4 overflow-hidden scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-gray-600 scrollbar-track-gray-200 dark:scrollbar-track-gray-800">
