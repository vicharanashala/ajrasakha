          ...
          {isLoadingReviewLevel ? (
            ...
            reviewLevel.map((level: any, ind: number) => (
              <TableRow key={ind} className="text-center">
                <TableCell className="align-middle w-36">{ind + 1}</TableCell>
                <TableCell className="align-middle w-36">{level.Review_level}</TableCell>
                <TableCell className="align-middle w-36">{level.pendingcount}</TableCell>
                <TableCell className="align-middle w-36">{level.completedcount}</TableCell>
              </TableRow>
            ))
          )}
        </TableBody>
