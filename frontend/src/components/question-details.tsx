      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {question && question.source == "AJRASAKHA" && currentUser && currentUser.role != "expert" &&
            <MessageDetail question={question} isQuestionAllocatedToExpert={submissionExists && question?.submission?.queue?.length === 0} navigateToQuestionPage={navigateToQuestionPage} />
          }
